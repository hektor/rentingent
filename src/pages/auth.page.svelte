  ...
  <div class="page">
    <form class="auth-form" on:submit|preventDefault={handleSubmit}>
      ...
      <div class="auth-provider_group">
        <button class="auth-provider auth-provider_google"
          ><img src="assets/icons/google.svg" alt="google-logo" /></button
        >
        <button class="auth-provider auth-provider_facebook"
          ><img src="assets/icons/facebook.svg" alt="facebook-logo" /></button
        >
      </div>
...
<style>
  ...
  .auth-provider {
    ...
    background: #fff;
    border: none;
    box-shadow: 0 0.5rem 1rem 0px rgba(0, 0, 0, 0.05);
    cursor: pointer;
